              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(fontWeight: FontWeight.w500, fontSize: 11, color: Theme.of(context).colorScheme.primary),
                  ),
                  const Spacer(),
                  Text(
        ...
        child: Column(
          ...
          children: [
            TextField(
              ...
              decoration: const InputDecoration(labelText: 'Banner Title', hintText: 'e.g. 50% Off Everything'),
            ),
            const SizedBox(height: 16),
            TextField(
              controller: _subtitleController,
              decoration: const InputDecoration(labelText: 'Subtitle (Optional)', hintText: 'e.g. Valid until Friday'),
            ),
            const SizedBox(height: 16),
            TextField(
              controller: _buttonTextController,
              decoration: const InputDecoration(labelText: 'Button Text', hintText: 'e.g. Shop Now'),
            ),
            const SizedBox(height: 16),
            TextField(
            ...
            SwitchListTile(
              title: const Text('Set as Active Immediately'),
              value: _isActive,
        ...
        ElevatedButton(
          onPressed: () {
            ...
            final newBanner = PromoBanner(
              ...
              buttonText: _buttonTextController.text.isNotEmpty ? _buttonTextController.text : 'Learn More',
